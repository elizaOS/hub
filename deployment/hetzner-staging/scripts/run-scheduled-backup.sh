...
validate_config() {
  ...
  BACKUP_ROOT="$(normalize_absolute_path "$BACKUP_ROOT")"
  ...
  BACKUP_SCHEDULE_LOCK_FILE="$(normalize_absolute_path "${BACKUP_SCHEDULE_LOCK_FILE:-$BACKUP_ROOT/.scheduled-backup.lock}")"
